...
"""`;
    ...
    case 'summaryChapter': {
      const isYouTube = /^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+/i.test(context.url);
      if (isYouTube) {
        promptText = `Analysiere und fasse dieses YouTube-Video in präzisen Zeitkapiteln zusammen.
...
- ...`;
        ...
        promptText = `Erstelle eine strukturierte Kapitel-Zusammenfassung des folgenden Inhalts (Beitrag / Artikel / Website).
